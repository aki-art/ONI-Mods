...
{
	public class AssignableGeneric : Assignable, IGameObjectEffectDescriptor
	{
		[MyCmpAdd]
		private AssignableGenericWorkable workable;
		...
		private void UpdateStatusString(IAssignableIdentity assignables)
		{
			...
			var status_item = assignee != null ? TStatusItems.AssignedStatus : Db.Get().BuildingStatusItems.Unassigned;
