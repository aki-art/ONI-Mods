...
namespace Twitchery.Content.Scripts
{
    ...
    {
        [SerializeField]
        public Storage raddishStorage;

        [SerializeField]
        public int consumedStages;
        ...
        public class States : GameStateMachine<States, SMInstance, Radish>
        {
            ...
            {
                default_state = arriving;

                arriving
                    //.EnterTransition(idle, HasAlreadyLanded)
                    .PlayAnim("falling")
                    .EventTransition(GameHashes.Landed, arrivingLanding);
