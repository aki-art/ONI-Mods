	...
	public class LocalizationPatch
	{
		...
		public class Localization_Initialize_Patch
		{
			public static void Postfix()
			{
				...
				Strings.Add("STRINGS.ITEMS.FOOD.AETE_JELLO.NAME", STRINGS.ELEMENTS.JELLO.NAME);
				Strings.Add("STRINGS.ITEMS.FOOD.AETE_JELLO.DESC", STRINGS.ELEMENTS.JELLO.DESC);

				Strings.Add("STRINGS.ITEMS.FOOD.AETE_FROZENHONEY.NAME", STRINGS.ELEMENTS.FROZENHONEY.NAME);
				Strings.Add("STRINGS.ITEMS.FOOD.AETE_FROZENHONEY.DESC", STRINGS.ELEMENTS.FROZENHONEY.DESC);
