...
| Mugshot | Several no-damage Mug comets spawn around the cursors, bringing Mug artifacts, but most break into just ceramic. | <code style="color : yellowgreen">Small</code> |
...
|-|-|-|-| 
| <code style="color : grey">Reworking</code> | Spawn the Hulk | A Duplicant canned Hulk is spawned. Hulk has +20 max strength (for a total of 40 cap), but has a small chance to break anything he touched. Workshopping: reworking the breaking to be stress denendent, and reworking sprites. | <code style="color : yellowgreen">Small</code> |
...
| <code style="color : red">Retired</code>  | Revive \<Duplicant\> | Revived a dead duplicant. This event has been permanently retired. | <code style="color : gray">None</code> |
...
| Event Name | Description | Danger |
|-|-|-|
| Super Dupe | Upgrade a Duplicant with extreme stat increase for 30 cycles. | <code style="color : gray">None</code> |
...
| Sandstorm | Sandy effect occludes your vision, and sand builds up on the floors. Sandworms will spawn, and depending on the max danger settings are visual (no danger), eat terrain (high) or eat duplicants (deadly). | <code style="color : yellowgreen">Small to Deadly</code> |
