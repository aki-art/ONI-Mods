...
namespace WorldTraitsPlus.Meteors
{
    class TungstenCometConfig : IEntityConfig
    {
        ...
        {
            GameObject gameObject = EntityTemplates.CreateEntity(ID, STRINGS.UI.SPACEDESTINATIONS.COMETS.TUNGSTENCOMET.NAME);
            ...
            primaryElement.SetElement(SimHashes.Tungsten);
