...
namespace Entropea.WorldTraits
{
	class MegaMeteorConfig : IEntityConfig
	{
		...
		public static string ID = "MegaComet";
		public GameObject CreatePrefab()
		{
			GameObject gameObject = EntityTemplates.CreateEntity(ID, "Mega comet");
			...
			comet.explosionEffectHash = (SpawnFXHashes)453;//SpawnFXHashes.MeteorImpactDirt;
