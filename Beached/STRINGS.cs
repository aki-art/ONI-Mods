namespace Beached
{
    public class STRINGS
    {
        ...
        {
            public class OCEANARIA_START_CLUSTER
            {
        ...
        public class ELEMENTS
        {
            public class BASALT
            {
                public static LocString NAME = "Basalt";
                public static LocString DESC = "ew";
            }
            ...
            {
                public static LocString NAME = "Salty Oxygen";
                public static LocString DESC = "ew";
            }

            public class BISMUTH
            {
                public static LocString NAME = "Bismuth";
                public static LocString DESC = "ew";
            }

            public class BISMUTHORE
            {
                public static LocString NAME = "Bismuth Ore";
                public static LocString DESC = "ew";
            }

            public class MOLTENBISMUTH
            {
                public static LocString NAME = "Molten Bismuth";
                public static LocString DESC = "ew";
            }

            public class BISMUTHGAS
            {
                public static LocString NAME = "Bismuth Gas";
                public static LocString DESC = "ew";
            }

            public class AQUAMARINE
            {
                public static LocString NAME = "Aquamarine";
                public static LocString DESC = "ew";
            }

            public class GRAVEL
            {
                public static LocString NAME = "Gravel";
                public static LocString DESC = "ew";
            }
        }
    }
