...
namespace PrintingPodRecharge.Settings
{
	public class RandoDupePresets
	{
		public static BundlaData.Rando Get(RandoDupeTier tier)
		{
			return tier switch
			{
				RandoDupeTier.Terrible => new BundlaData.Rando()
				{
				...
				RandoDupeTier.Vanillaish => new BundlaData.Rando()
				{
				...
				RandoDupeTier.Generous => new BundlaData.Rando()
				{
					MinimumSkillBudgetModifier = 0,
				...
				_ => BundleLoader.bundleSettings.defaultRandoPreset,
			};
		}
	}
}
