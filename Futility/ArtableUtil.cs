...
namespace FUtility
{
	public class ArtableUtil
	{
		...
		public static string AddStageLegacy(ArtableStages __instance, string buildingId, string kanimPrefix, string name, string description, string id, int decor, ArtableStatusType status, string animName = null)
		{
			var fullId = buildingId + "_" + id;
