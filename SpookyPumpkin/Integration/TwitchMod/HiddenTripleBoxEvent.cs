...
namespace SpookyPumpkinSO.Integration.TwitchMod
{
	public class HiddenTripleBoxEvent : HiddenEventBase
	{
		...
		public override void Run()
		{
			...
			ToastManager.InstantiateToastWithGoTarget(STRINGS.UI.SPOOKYPUMPKIN.TWITCHEVENTS.TRICKORTREAT.TREAT, STRINGS.UI.SPOOKYPUMPKIN.TWITCHEVENTS.TRIPLEBOX.TOAST_BODY,
				target);
		}
	}
}
