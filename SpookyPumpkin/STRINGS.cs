	...
	public class STRINGS
	{
			...
			public static class PREFABS
			{
				public static class LUXURYBED
				{
					public static class FACADES
					{
						...
						{
							public static LocString NAME = Utils.FormatAsLink("Pumpkin Pit Bed", LuxuryBedConfig.ID);
				...
				{
					public static LocString NAME = Utils.FormatAsLink("Jack O' Lantern", SpookyPumpkinConfig.ID);
				...
				{
					public static LocString NAME = Utils.FormatAsLink("Friendly Pumpkin Lantern", FriendlyPumpkinConfig.ID);
		...
		public class DUPLICANTS
		{
			...
			public class STATUSITEMS
			{
				...
				public class SP_GHASTLYLITBONUS
				{
					...
					public static LocString TOOLTIP = "<b>Properties</b>\n    • <style=\"KKeyword\">Work Speed</style>: {0}\n    • <style=\"KKeyword\">Stress</style>: {1}";
				}
		...
		public class EQUIPMENT
		{
			public class PREFABS
			{
				...
				{
					public static LocString GENERICNAME = Utils.FormatAsLink("Halloween Costume", HalloweenCostumeConfig.ID);
					public static LocString NAME = Utils.FormatAsLink("Halloween Costume", HalloweenCostumeConfig.ID);

					public class FACADES
					{
						public static LocString SP_VAMPIRECOSTUME = Utils.FormatAsLink("Vampire Costume", HalloweenCostumeConfig.ID);
						public static LocString SP_SCARECROWCOSTUME = Utils.FormatAsLink("Scarecrow Costume", HalloweenCostumeConfig.ID);
						public static LocString SP_JACKSKELLINGTONCOSTUME = Utils.FormatAsLink("Skellington Costume", HalloweenCostumeConfig.ID);
					}
				}
			}
		}
		...
		public class ITEMS
		{
			...
			public class FOOD
			{
				public class SP_PUMPKIN
				{
					...
					public static LocString DESC = $"Bland tasting fruit of a {Utils.FormatAsLink("Pumpkin", PumpkinPlantConfig.ID)} plant.";
				}
				...
				public class SP_PUMPKINPIE
				{
					...
					public class DEHYDRATED
					{
						...
						public static LocString DESC = $"A dehydrated {SP_PUMPKINPIE.NAME} ration." +
							$" It must be rehydrated in order to be considered {Utils.FormatAsLink("Food", "FOOD")}." +
							$"\n" +
							$"\n" +
		...
		public class CREATURES
		{
			public class SPECIES
			{
				...
				{
					public static LocString NAME = Utils.FormatAsLink("Suspicious Pip", "SQUIRREL");
				...
				public class SP_PUMPKIN
				{
					...
					public static LocString DESC = $"Pumpkins are pretty neat. They grow enormous fruits also called {Utils.FormatAsLink("Pumpkins", PumpkinConfig.ID)}.";
