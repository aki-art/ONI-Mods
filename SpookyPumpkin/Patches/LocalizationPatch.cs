	...
	public class LocalizationPatch
	{
		...
		public class Localization_Initialize_Patch
		{
			public static void Postfix()
			{
                ...
                Strings.Add("STRINGS.MISC.TAGS.SP_BUILDPUMPKIN", STRINGS.ITEMS.FOOD.SP_PUMPKIN.NAME);
                Strings.Add("STRINGS.MISC.TAGS.SP_BUILDPUMPKIN_DESC", STRINGS.ITEMS.FOOD.SP_PUMPKIN.DESC);
            }
		}
	}
}
